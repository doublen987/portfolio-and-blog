...
// source: /home/doublen987/workspace/go/src/github.com/doublen987/Projects/MySite/server/webportal/template/blog/blog.html
// DO NOT EDIT!
package template
...
func HandleBlog(ctx context.Context, settings models.Settings, posts []models.Post, currentPage int, pageBlockStart int, numOfPages int, w io.Writer) {
...
<body>
    ...
    <main>
        `)
	_buffer.WriteString(`
    <script src="/content/js/gettags.js"></script>
	...
	for _, post := range posts {
		...
		if post.Thumbnail != "" {
			_buffer.WriteString(`
                    <img class="post-image" src="/content/images/`)
			hero.EscapeHTML(post.Thumbnail, _buffer)
			_buffer.WriteString(`"/>
                `)
		} else {
			_buffer.WriteString(`
                    <img class="post-image" src="/content/no-image.png"/>
                `)
		}
		_buffer.WriteString(`
                <a href="/blog/`)
		hero.EscapeHTML(post.ID, _buffer)
		_buffer.WriteString(`" class="post-card-title">`)
		_buffer.WriteString(post.Title)
		_buffer.WriteString(`</a>
                <div class="post-card-description">`)
		_buffer.WriteString(post.Description)
    ...
    <script>
        ...
        //     let tagElement = document.getElementsByClassName("post-tag")
        //     let tag = binarySearch(tags, tagElement.id.replace("tag"))
