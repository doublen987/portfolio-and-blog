...
// source: /home/doublen987/workspace/go/src/github.com/doublen987/Projects/MySite/server/webportal/template/knowledge-timeline/timeline.html
// DO NOT EDIT!
package template
...
func HandleKnowledgeTimeline(ctx context.Context, settings models.Settings, timeline []models.TimelineEvent, w io.Writer) {
...
<body>
    ...
    <div class="timeline-container">
        ...
        `)
	for id, event := range timeline {
		_buffer.WriteString(`
            <div id="timeline-event-`)
		hero.FormatInt(int64(id), _buffer)
		_buffer.WriteString(`" class="timeline-event">
                <div class="timeline-event-image">
                    `)
		if event.Image != "" {
			_buffer.WriteString(`
                        <img class="project-image" src="/content/images/`)
			hero.EscapeHTML(event.Image, _buffer)
			_buffer.WriteString(`"/>
                    `)
		} else {
			_buffer.WriteString(`
		...
		hero.EscapeHTML(event.Title, _buffer)
		_buffer.WriteString(`</div>
                <div class="timeline-event-description">`)
		hero.EscapeHTML(event.Description, _buffer)
		_buffer.WriteString(`</div>
            </div>
        `)
	}
