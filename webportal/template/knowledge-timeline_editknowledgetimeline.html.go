...
// source: /home/doublen987/workspace/go/src/github.com/doublen987/Projects/MySite/server/webportal/template/knowledge-timeline/editknowledgetimeline.html
// DO NOT EDIT!
package template
...
func HandleEditKnowledgeTimeline(ctx context.Context, settings models.Settings, timeline []models.TimelineEvent, w io.Writer) {
...
<body>
	...
	for _, event := range timeline {
		_buffer.WriteString(`
                        <option value="`)
		hero.EscapeHTML(event.ID, _buffer)
		_buffer.WriteString(`">`)
